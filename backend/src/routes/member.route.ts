...
import { getMembers, removeMember, updateMemberRole } from "../controller/member.controller.js";
...
router.delete('/members/:memberId', authMiddleware, validateParams(memberParamsSchema), removeMember)
